...
package eu.schwicloud.language;

import com.fasterxml.jackson.databind.ObjectMapper;
import eu.schwicloud.Driver;
import eu.schwicloud.configuration.ConfigDriver;
import eu.schwicloud.language.entry.LanguageConfig;
import eu.schwicloud.language.entry.LanguagePacket;
import eu.schwicloud.language.entry.LanguagesPacket;
