...
import eu.schwicloud.config.ActivityConfiguration;
import eu.schwicloud.config.Configuration;
import eu.schwicloud.configuration.ConfigDriver;
import eu.schwicloud.events.CloudEvents;
...
public class DiscordModule implements IModule {
    ...
    public void load() {
        if (!new File("./modules/discord/config.json").exists()) {
            ...
            activityConfiguration.setActivity(eu.schwicloud.config.Activity.custom);
    ...
    private void initialisationDiscordBotHook(){
        ...
        jda = JDABuilder
                ...
                .setActivity(
                        configuration.getActivity().getActivity() == eu.schwicloud.config.Activity.competing ? Activity.competing(configuration.getActivity().getDiscordActivity()) :
                                configuration.getActivity().getActivity() == eu.schwicloud.config.Activity.listening ? Activity.listening(configuration.getActivity().getDiscordActivity()) :
                                        configuration.getActivity().getActivity() == eu.schwicloud.config.Activity.playing ? Activity.playing(configuration.getActivity().getDiscordActivity()) :
                                                configuration.getActivity().getActivity() == eu.schwicloud.config.Activity.watching ? Activity.customStatus(configuration.getActivity().getDiscordActivity()) :
